...
module.exports = {
	name: "oidasgiven",
	aliases: ["oidagiven"],
	description: "Oida Leaderboard. Zeigt an welcher user am meisten oidas ausgeteilt hat",
	cooldown: 10,
		...
		message.guild.members.fetch()
			.then((members) => {
				...
				Object.keys(oidacount).forEach((k) => {
					...
					oidaLeaderboard.push({ name: name, count: oidacount[k].oidasgiven });
				});
				...
				let leaderboardString = "**Oidas Given Leaderboard**\n```\n";
